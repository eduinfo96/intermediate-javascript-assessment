...
context1 = ( myFn, context, param1, param2 ) => {
...
sentenceMachine = ( partOne ) => {
  ...
  return sentenceSmasher = ( partTwo ) => {
...
subway = ( personName ) => {
  ...
  return addIngredient = ( ingredient ) => {
    customer.ingredients.push( ingredient );
